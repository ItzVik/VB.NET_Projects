...
Imports System.IO
Public Class veselinovicnemanja
    Dim a As Integer = 0
    Dim path As String = "c:\Dnevnik"
    Dim path1 As String = "c:\Dnevnik\veselinovicnemanja"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf CheckBox1.Checked = True Then
            ...
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\veselinovicnemanja\Ocena.txt", TextBox1.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\veselinovicnemanja\Opis.txt", TextBox2.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\veselinovicnemanja\Predmet.txt", TextBox3.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\veselinovicnemanja me.txt", "Znaci da vam objasnim. Ako je prva ocena(naprimer:5), a prvi ucenik(naprimer:Leo),a prvi predmet(naprimer:Srpski Jezik), a prvi opis(Naprimer:Grupni Rad) to znaci da je sve to od tog prvog ucenika. Pokusavam da to poboljsam. I sve ce vam verovatno biti spojeno tako da preporucujem da uvek kad nesto upisujete da na kraju stavite razmak. Nadam se da vam je ovo pomoglo!!", True)
