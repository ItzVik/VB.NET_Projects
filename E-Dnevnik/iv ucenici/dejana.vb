...
Public Class dejana
    ...
    Dim path1 As String = "c:\Dnevnik\dejana"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf CheckBox1.Checked = True Then
            ...
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\dejana\Opis.txt", TextBox2.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\dejana\Predmet.txt", TextBox3.Text, True)
