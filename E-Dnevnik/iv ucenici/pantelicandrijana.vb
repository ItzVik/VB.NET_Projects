...
Imports System.IO
Public Class pantelicandrijana
    Dim a As Integer = 0
    Dim path As String = "c:\Dnevnik"
    Dim path1 As String = "c:\Dnevnik\pantelicandrijana"
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ElseIf CheckBox1.Checked = True Then
            ...
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\pantelicandrijana\Ocena.txt", TextBox1.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\pantelicandrijana\Opis.txt", TextBox2.Text, True)
            My.Computer.FileSystem.WriteAllText("c:\Dnevnik\pantelicandrijana\Predmet.txt", TextBox3.Text, True)
