...
namespace Hystel_Launcher
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (Directory.Exists(@"C:\HystelLauncher\.minecraft") == false)
            {
                Directory.CreateDirectory(@"C:\HystelLauncher\.minecraft");
            }

            if (File.Exists(@"C:\HystelLauncher\.minecraft\hystelmclastlogin") == false)
            {
                StreamWriter URaDummyJoel = new StreamWriter(@"C:\HystelLauncher\.minecraft\hystelmclastlogin"); // This creates a blank file
                URaDummyJoel.Close();
            }

            StreamReader loginInfo = new StreamReader(@"C:\HystelLauncher\.minecraft\hystelmclastlogin");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                StreamWriter logininfo = new StreamWriter(@"C:\HystelLauncher\.minecraft\hystelmclastlogin");
            ...
            {
                StreamWriter logininfo = new StreamWriter(@"C:\HystelLauncher\.minecraft\hystelmclastlogin"); // creates blank file; overwrites old file
                logininfo.Close();
            }

            bool ismodded = false;
            bool clientExists = false;
            string folderlocation = @"C:\HystelLauncher\.minecraft";
        ...
        private void StartMinecraft(string username, string session)
        {
            ...
            {
                Environment.SetEnvironmentVariable("APPDATA", "C:\\HYSTELMC\\");
